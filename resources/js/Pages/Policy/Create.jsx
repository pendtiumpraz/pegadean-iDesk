...
export default function KebijakanCreate({ parentPolicies = [] }) {
    ...
    return (
        <AppLayout title="Tambah Kebijakan">
            <PageHeader
                ...
                description="Tambahkan kebijakan baru ke repository — AI Co-pilot akan mengekstrak metadata dari dokumen yang diunggah."
                breadcrumbs={[
            ...
            <div style={{ marginBottom: 16 }}>
                <AISuggestionCallout
                    ...
                    body={
                        <>
                            Setelah upload, AI Co-pilot akan mengekstrak nomor, kategori, versi, dan kutipan pasal — Anda tinggal mereview hasilnya.
                            <div className="ai-suggest" style={{ marginTop: 10 }}>
                                <button type="button" className="s">Sarankan kategori</button>
                                <button type="button" className="s">Auto-isi ringkasan</button>
                                <button type="button" className="s">Deteksi pasal kunci</button>
                            </div>
                        </>
                    }
                />
            ...
            <form onSubmit={submit}>
                <div className="card">
                    <div className="card-head">
                        <div>
                            ...
                            <div className="sub">Kode, judul, klasifikasi, versi, dan masa berlaku.</div>
                        </div>
                    </div>
                        ...
                        <div style={fieldGrid}>
                            ...
                            <Field label="Judul *" error={form.errors.title} fullWidth>
                                <input
                                    ...
                                    placeholder="Contoh: Kebijakan Induk Manajemen Risiko Korporasi"
                                    required
                                />
                            </Field>
                            ...
                            <Field label="Ringkasan" error={form.errors.summary} fullWidth>
                                <textarea
                                    ...
                                    placeholder="Ringkasan singkat kebijakan…"
                                />
                            </Field>
                            ...
                            <Field label="Kutipan Pasal" error={form.errors.excerpt} fullWidth>
                                <textarea
                                    ...
                                    placeholder="Kutipan pasal kunci dari dokumen…"
                                />
                            </Field>
                            ...
                            <Field label="Rujukan Pasal" error={form.errors.pasal_ref}>
                                <input
                                    ...
                                    placeholder="Pasal 6 ayat (3)"
                                />
                            </Field>

                            <Field label="Unggah Dokumen" error={form.errors.file} fullWidth>
                                <div
                                ...
                                >
                                    ...
                                    <div style={{ fontWeight: 600, marginTop: 8 }}>
                                        {form.data.file ? form.data.file.name : 'Tarik & lepaskan file di sini'}
                                    </div>
                                    <div style={{ fontSize: 12, color: 'var(--ink-500)', marginTop: 4 }}>
                                        DOCX, PDF — maks 20MB · AI menganalisa otomatis setelah upload
                                    </div>
                ...
                <div style={{ marginTop: 16, display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                    <Link href={route('policies.index')} className="btn ghost">Batal</Link>
